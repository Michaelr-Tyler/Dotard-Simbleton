...
export const onlyNYBusinesses = businesses.filter(businessObj => {
    if (businessObj.addressStateCode === "NY") {
        return businessObj
    }
})

export const agentArray = businesses.map(agentObj => {
    return {
        firstName: agentObj.purchasingAgent.nameFirst,
        lastName: agentObj.purchasingAgent.nameLast,
        work: agentObj.companyName,
